...
const main = async function() {
  ...
  let createElementsP2pkhAddressResult;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    createElementsP2pkhAddressResult = await CreateAddress(reqJson);
  ...
  let createElementsP2shAddressResult;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    createElementsP2shAddressResult = await CreateAddress(reqJson);
  ...
  let createElementsP2shP2wpkhAddressResult;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    createElementsP2shP2wpkhAddressResult = await CreateAddress(reqJson);
  ...
  let getElementsConfidentialAddressResult;
  {
    ...
    getElementsConfidentialAddressResult =
        await GetConfidentialAddress(reqJson);
    console.log('\n*** Response ***\n',
        getElementsConfidentialAddressResult, '\n');
  }
  ...
  let getUnblindedAddressResult;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    getUnblindedAddressResult = await GetUnblindedAddress(reqJson);
  ...
  let CreateElementsSignatureHashResult;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    CreateElementsSignatureHashResult =
        await CreateElementsSignatureHash(reqJson);
    console.log('\n*** Response ***\n',
        CreateElementsSignatureHashResult, '\n');
  }
  ...
  let addWitnessStack1;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    addWitnessStack1 = await AddSign(reqJson);
    console.log('\n*** Response ***\n', addWitnessStack1, '\n');
  }
  ...
  let updateWitnessStack1;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    updateWitnessStack1 = await UpdateWitnessStack(reqJson);
    console.log('\n*** Response ***\n', updateWitnessStack1, '\n');
  }
  ...
  let elementsCreateRawTransactionResult;
  {
    ...
    elementsCreateRawTransactionResult =
        await ElementsCreateRawTransaction(reqJson);
    console.log('\n*** Response ***\n',
        elementsCreateRawTransactionResult, '\n');
  }
  ...
  let blindRawTransactionResult;
  {
    ...
    /* eslint-enable max-len */
    console.log('*** Request ***\n', reqJson);
    blindRawTransactionResult = await BlindRawTransaction(reqJson);
  ...
  let elementsAddRawTransactionResult;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    elementsAddRawTransactionResult = await ElementsAddRawTransaction(reqJson);
    console.log('\n*** Response ***\n',
  ...
  let SetRawIssueAssetResult;
  {
    ...
    /* eslint-enable max-len */
    console.log('*** Request ***\n', reqJson);
    SetRawIssueAssetResult = await SetRawIssueAsset(reqJson);
  ...
  let UnblindRawTransactionResult;
  {
    ...
    /* eslint-enable max-len */
    console.log('*** Request ***\n', reqJson);
    UnblindRawTransactionResult = await UnblindRawTransaction(reqJson);
  ...
  let blindRawTransactionResult2;
  {
    ...
    /* eslint-enable max-len */
    console.log('*** Request ***\n', reqJson);
    blindRawTransactionResult2 = await BlindRawTransaction(reqJson);
  ...
  let UnblindRawTransactionResult1;
  {
    ...
    /* eslint-enable max-len */
    console.log('*** Request ***\n', reqJson);
    UnblindRawTransactionResult1 = await UnblindRawTransaction(reqJson);
  ...
  let addSign1;
  {
    ...
    addSign1 = await AddSign(reqJson);
    console.log('\n*** Response ***\n', addSign1, '\n');
  }
  ...
  let addSign2;
  {
    ...
    /* eslint-enable max-len */
    console.log('*** Request ***\n', JSON.stringify(reqJson, null, '  '));
    addSign2 = await AddSign(reqJson);
    console.log('\n*** Response ***\n', addSign2, '\n');
  }
  ...
  let IssuanceSetRawIssueAssetResult;
  {
    ...
    /* eslint-enable max-len */
    console.log('*** Request ***\n', reqJson);
    IssuanceSetRawIssueAssetResult = await SetRawIssueAsset(reqJson);
  ...
  let IssuanceBlindRawTransactionResult;
  {
    ...
    /* eslint-enable max-len */
    console.log('*** Request ***\n', reqJson);
    IssuanceBlindRawTransactionResult = await BlindRawTransaction(reqJson);
    console.log('\n*** Response ***\n',
  ...
  let IssuanceUnblindRawTransactionResult;
  {
    ...
    /* eslint-enable max-len */
    IssuanceUnblindRawTransactionResult = await UnblindRawTransaction(reqJson);
    console.log('\n*** Response ***\n',
  ...
  let reissuanceSetRawReissueAssetResult;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    reissuanceSetRawReissueAssetResult = await SetRawReissueAsset(reqJson);
    console.log('\n*** Response ***\n',
  ...
  let getDefaultBlindingKeyResult;
  {
    ...
    console.log('\n*** Request ***\n', reqJson);
    getDefaultBlindingKeyResult = await GetDefaultBlindingKey(reqJson);
  ...
  let getIssuanceBlindingKeyResult;
  {
    ...
    console.log('\n*** Request ***\n', reqJson);
    getIssuanceBlindingKeyResult = await GetIssuanceBlindingKey(reqJson);
    console.log('\n*** Response ***\n', getIssuanceBlindingKeyResult, '\n');
  }
  ...
  let reissuanceBlindRawTransactionResult;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    reissuanceBlindRawTransactionResult = await BlindRawTransaction(reqJson);
    console.log('\n*** Response ***\n',
  ...
  let reissuanceUnblindRawTransactionResult;
  {
    ...
    reissuanceUnblindRawTransactionResult =
        await UnblindRawTransaction(reqJson);
    console.log('\n*** Response ***\n',
        reissuanceUnblindRawTransactionResult, '\n');
  }
  ...
  let createPegInAddressResult1;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    createPegInAddressResult1 = await CreatePegInAddress(reqJson);
    console.log('\n*** Response ***\n',
        createPegInAddressResult1, '\n');
    const addrInfo = await GetAddressInfo({
  ...
  let createPegInAddressResult2;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    createPegInAddressResult2 = await CreatePegInAddress(reqJson);
    console.log('\n*** Response ***\n',
  ...
  let peginCreateRawPeginResult;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    peginCreateRawPeginResult = await CreateRawPegin(reqJson);
  ...
  let pegoutCreateRawPegoutResult;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    pegoutCreateRawPegoutResult = await CreateRawPegout(reqJson);
...

  {
    ...
    /* eslint-enable max-len */
    const result = await ElementsDecodeRawTransaction(reqJson);
    console.log('\n*** Response ***\n',
  ...
  let destroyAmountCreateDestroyAmountResult;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    destroyAmountCreateDestroyAmountResult = await CreateDestroyAmount(reqJson);
    console.log('\n*** Response ***\n',
  ...
  let estimateFeeIssueResult;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    estimateFeeIssueResult = await EstimateFee(reqJson);
  ...
  let getAddressInfo3Result;
  {
    ...
    const multisigResult = await CreateMultisig({
      'nrequired': 2,
      'keys': [
        '0205ffcdde75f262d66ada3dd877c7471f8f8ee9ee24d917c3e18d01cee458bafe',
        '02be61f4350b4ae7544f99649a917f48ba16cf48c983ac1599774958d88ad17ec5',
  ...
  let serializeLedgerFormatResult;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    serializeLedgerFormatResult = await SerializeLedgerFormat(reqJson);
  ...
  let getCommitmentResult;
  {
    ...
    console.log('*** Request ***\n', reqJson);
    getCommitmentResult = await GetCommitment(reqJson);
    console.log('\n*** Response ***\n', getCommitmentResult, '\n');
  }
};
